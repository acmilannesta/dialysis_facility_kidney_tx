...
data work.ptwtlist;
	merge work.ptmedevid (in=a) work.waitlist (in=b keep = keep = usrds_id abo adate age_listing cal_pra cpra ctr_ty dialysis
...
proc contents data=core_cd.USRDS_Source2017;
run;
